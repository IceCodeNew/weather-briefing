...
headline_source_ids、overview_source_ids 以及 conclusions、active_warnings、disaster_tracking 和 advice
...
active_warnings 已表达的预警事实不得在 conclusions 中重复；
headline 或 overview 已表达的事实也不要在 conclusions 原样重复。
